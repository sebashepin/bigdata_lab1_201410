...
/**
 * @author Sebastian
 * Template de http://hadoopi.wordpress.com/2013/05/31/custom-recordreader-processing-string-pattern-delimited-records/
 */
public class NewsRecordReader extends RecordReader<LongWritable, Text> {
	...
	private static final Log LOG = LogFactory.getLog(NewsRecordReader.class);
