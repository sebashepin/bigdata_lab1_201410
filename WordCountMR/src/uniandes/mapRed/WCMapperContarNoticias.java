...
public class WCMapperContarNoticias extends Mapper<LongWritable, Text, Text, IntWritable> {
	...
	protected void map(LongWritable key, Text value,
		...
		for(String palabra:palabras){
			...
			//Para el conteo de noticias, si no es una noticia, no tenga en cuenta la línea
			if(!lw.startsWith("<title>")){continue;}
			palabrasLinea.put("NOTICIAS",
					palabrasLinea.containsKey("NOTICIAS")?
